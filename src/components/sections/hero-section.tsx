...
export function HeroSection() {
  ...
  const subtleX = useTransform(smoothX, [0, 1], [-10, 10]);
  ...
  return (
    ...
    >
      {/* Ambient backdrop: rotating mega-arc */}
      {!reduce && (
        <motion.div
          aria-hidden
      ...
      {/* Ambient backdrop: breathing ultramarine glow following cursor */}
      {!reduce && (
        <motion.div
          aria-hidden
          className="pointer-events-none absolute inset-0 -z-10"
      ...
      <div className="container-page flex-1 flex flex-col relative z-10">
        ...
        <div className="flex-1 flex items-center justify-center -mt-4">
          <motion.div
            className="w-full text-center max-w-5xl mx-auto px-4"
            style={!reduce ? { x: subtleX } : undefined}
          >
            <h1
              id="hero-heading"
            ...
            {/* underline that draws across after copy reveal */}
            <motion.div
              aria-hidden
              className="mx-auto mt-10 h-px bg-ink/50 origin-left"
        ...
        {/* Bottom: meta + sweeping line + scroll cue */}
        <motion.div
