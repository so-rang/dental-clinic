...
export const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "가능합니다. 이전 병원의 진료 기록이나 영상 자료를 가져오시면 진료 연속성을 확보할 수 있고, 정단아치과에서 추가 진단을 통해 남은 치료 계획을 조정해 드립니다. 기록이 없으셔도 초진을 통해 현재 상태를 확인합니다.",
    category: "process",
    featured: true,
  },
  {
    ...
    answer:
      "임플란트는 수술이 끝나는 시점이 아니라 시작점입니다. 정단아치과는 임플란트 수술 후 10년 정기 점검 프로토콜을 운영합니다. 6개월마다 점검과 전문가 잇솔질을 받으시고, 필요시 보철물 교체나 잇몸 관리를 진행합니다. 같은 의료진이 계속 봐드립니다.",
    category: "treatment",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    answer:
      "직장인분들을 위한 야간 진료는 매주 수요일에 운영합니다. 평일 진료가 어려우신 경우 예약 페이지에서 ‘수요일 야간’ 슬롯을 선택하시거나 카카오톡 채널(@dan-a-dental)로 직접 요청해 주세요. 야간 슬롯은 한 주 전부터 오픈됩니다.",
    category: "operation",
  },
  {
    question: "주차는 가능한가요?",
  ...
  },
  {
    ...
    answer:
      "예약 시간 24시간 전까지 카카오톡 채널(@dan-a-dental) 또는 대표 전화(02-538-1004)로 알려주시면 위약금 없이 변경·취소가 가능합니다. 당일 취소는 다른 환자분의 진료 기회가 줄어들 수 있어 가능한 한 사전에 연락 부탁드립니다.",
    category: "operation",
  },
];
